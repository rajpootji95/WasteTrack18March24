...
class StateGovNylonManagementDetails extends StatefulWidget {
  const StateGovNylonManagementDetails({super.key});

  @override
  State<StateGovNylonManagementDetails> createState() =>
      _StateGovNylonManagementDetailsState();
}

class _StateGovNylonManagementDetailsState
    extends State<StateGovNylonManagementDetails>
