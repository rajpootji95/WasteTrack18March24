...
class StateGovTicketDetails extends StatefulWidget {
  const StateGovTicketDetails({super.key});

  @override
  State<StateGovTicketDetails> createState() => _StateGovTicketDetailsState();
}

class _StateGovTicketDetailsState extends State<StateGovTicketDetails> {
