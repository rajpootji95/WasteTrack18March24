...
class _AllVendorState extends State<AllVendor> {
  ...
  final allVendorVisibilityController = Get.put(VendorManagementController());
  @override
                    ...
                    return Stack(clipBehavior: Clip.none, children: [
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            allVendorVisibilityController.AllVendorVisibility(
                                index);
                          },
                          child: Image.asset(
                            AppImages.opestion,
                      ...
                      Positioned(
                        ...
                        top: -8,
                        child: Visibility(
                          visible: allVendorVisibilityController
                              .allVendorVisibleList[index],
                          child: GestureDetector(
                            onTap: () {
                              Navigator.pushNamed(
                                  context, AppScreen.allVendorDetailsScreen);
                            },
                            child: Container(
                              child: Image.asset(
                                AppImages.eye,
