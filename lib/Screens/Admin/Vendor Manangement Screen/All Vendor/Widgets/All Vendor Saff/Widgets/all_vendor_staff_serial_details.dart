...
class AllVeStaffSerialDetails extends StatefulWidget {
  const AllVeStaffSerialDetails({super.key});

  @override
  State<AllVeStaffSerialDetails> createState() =>
      _AllVeStaffSerialDetailsState();
}

class _AllVeStaffSerialDetailsState extends State<AllVeStaffSerialDetails> {
