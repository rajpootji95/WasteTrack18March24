...
class AdminTicketsDetails extends StatefulWidget {
  const AdminTicketsDetails({super.key});

  @override
  State<AdminTicketsDetails> createState() => _AdminTicketsDetailsState();
}

class _AdminTicketsDetailsState extends State<AdminTicketsDetails> {
