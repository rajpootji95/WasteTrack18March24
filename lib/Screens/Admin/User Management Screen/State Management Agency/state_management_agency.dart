...
class StateManagementAgency extends StatefulWidget {
  const StateManagementAgency({super.key});

  @override
  State<StateManagementAgency> createState() => _StateManagementAgencyState();
}

class _StateManagementAgencyState extends State<StateManagementAgency> {
  bool isButtonSelected = false;
  final controller = Get.put(StateGovernmentAgencyController());
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.pushNamed(context,
                              AppScreen.stateGovernmentAgencyEditScreen);
                        },
                        child: Container(
