...
class WasteManagementAgencyEdit extends StatefulWidget {
  const WasteManagementAgencyEdit({super.key});

  @override
  State<WasteManagementAgencyEdit> createState() =>
      _WasteManagementAgencyEditState();
}

class _WasteManagementAgencyEditState extends State<WasteManagementAgencyEdit> {
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                ' Edit Waste Management Agency Details',
                style: TextStyle(
