...
class SubAdminEditScreen extends StatefulWidget {
  final GetSubAdminResponseModel? model;
  final int? index;
   SubAdminEditScreen({super.key,this.model,this.index});


  @override
  State<SubAdminEditScreen> createState() => _SubAdminEditScreenState();
}

class _SubAdminEditScreenState extends State<SubAdminEditScreen> {
  @override
  void initState() {
                              ...
                              CustomButton(
                                ...
                                onPressed: () async {
                                    if(formKey.currentState!.validate()) {
                                      controller.updateSubAdminList(
                                          emailController.text,
                                          passwordController.text,
                                          firstNameController.text,
                                          lastNameController.text,
                                          mobileController.text,
                                          controller.model!.data[widget.index!]
                                              .id);
                                    }else{
