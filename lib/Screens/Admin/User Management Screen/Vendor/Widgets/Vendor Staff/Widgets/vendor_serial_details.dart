...
class VendorSerialDetails extends StatefulWidget {
  const VendorSerialDetails({super.key});

  @override
  State<VendorSerialDetails> createState() => _VendorSerialDetailsState();
}

class _VendorSerialDetailsState extends State<VendorSerialDetails> {
