...
class WasAgencyWasteCollection extends StatefulWidget {
  const WasAgencyWasteCollection({super.key});

  @override
  State<WasAgencyWasteCollection> createState() =>
      _WasAgencyWasteCollectionState();
}

class _WasAgencyWasteCollectionState extends State<WasAgencyWasteCollection>
