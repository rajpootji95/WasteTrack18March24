...
class WasAgencyTicketing extends StatefulWidget {
  const WasAgencyTicketing({super.key});

  @override
  State<WasAgencyTicketing> createState() => _WasAgencyTicketingState();
}

class _WasAgencyTicketingState extends State<WasAgencyTicketing>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushNamed(
              context, AppScreen.wasAgencyCreateTicketingScreen);
        },
