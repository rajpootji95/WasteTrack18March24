...
class WasAgencyTicketDetails extends StatefulWidget {
  const WasAgencyTicketDetails({super.key});

  @override
  State<WasAgencyTicketDetails> createState() => _WasAgencyTicketDetailsState();
}

class _WasAgencyTicketDetailsState extends State<WasAgencyTicketDetails> {
