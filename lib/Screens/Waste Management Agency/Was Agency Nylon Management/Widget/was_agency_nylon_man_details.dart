...
class WasAgencyNylonManagementDetails extends StatefulWidget {
  const WasAgencyNylonManagementDetails({super.key});

  @override
  State<WasAgencyNylonManagementDetails> createState() =>
      _WasAgencyNylonManagementDetailsState();
}

class _WasAgencyNylonManagementDetailsState
    extends State<WasAgencyNylonManagementDetails>
