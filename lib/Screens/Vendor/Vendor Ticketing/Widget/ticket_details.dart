...
class VendorTicketingDetails extends StatefulWidget {
  const VendorTicketingDetails({super.key});

  @override
  State<VendorTicketingDetails> createState() => _VendorTicketingDetailsState();
}

class _VendorTicketingDetailsState extends State<VendorTicketingDetails> {
