...
class VendorTicket extends StatefulWidget {
  const VendorTicket({super.key});

  @override
  State<VendorTicket> createState() => _VendorTicketState();
}

class _VendorTicketState extends State<VendorTicket> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushNamed(context, AppScreen.vendorCreateTicketingScreen);
        },
