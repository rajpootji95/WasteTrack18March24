...
class VenStaffTicketing extends StatefulWidget {
  const VenStaffTicketing({super.key});

  @override
  State<VenStaffTicketing> createState() => _VenStaffTicketingState();
}

class _VenStaffTicketingState extends State<VenStaffTicketing>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushNamed(
              context, AppScreen.vendorStaffCreateTicketingScreen);
        },
