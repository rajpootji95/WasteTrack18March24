...
class VenStaffCreateTicket extends StatefulWidget {
  const VenStaffCreateTicket({super.key});

  @override
  State<VenStaffCreateTicket> createState() => _VenStaffCreateTicketState();
}

class _VenStaffCreateTicketState extends State<VenStaffCreateTicket> {
