...
class WasStaffTicketing extends StatefulWidget {
  const WasStaffTicketing({super.key});

  @override
  State<WasStaffTicketing> createState() => _WasStaffTicketingState();
}

class _WasStaffTicketingState extends State<WasStaffTicketing>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushNamed(context, AppScreen.wasStaffCreateTicketingScreen);
        },
