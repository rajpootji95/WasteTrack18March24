...
class WasStaffCreateTicket extends StatefulWidget {
  const WasStaffCreateTicket({super.key});

  @override
  State<WasStaffCreateTicket> createState() => _WasStaffCreateTicketState();
}

class _WasStaffCreateTicketState extends State<WasStaffCreateTicket> {
