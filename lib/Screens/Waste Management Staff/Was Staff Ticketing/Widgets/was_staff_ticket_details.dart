...
class WasStaffTicketDetails extends StatefulWidget {
  const WasStaffTicketDetails({super.key});

  @override
  State<WasStaffTicketDetails> createState() => _WasStaffTicketDetailsState();
}

class _WasStaffTicketDetailsState extends State<WasStaffTicketDetails> {
