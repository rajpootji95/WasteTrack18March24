...
class VendorStaffPurSerialDetails extends StatefulWidget {
  const VendorStaffPurSerialDetails({super.key});

  @override
  State<VendorStaffPurSerialDetails> createState() =>
      _VendorStaffPurSerialDetailsState();
}

class _VendorStaffPurSerialDetailsState
    extends State<VendorStaffPurSerialDetails> {
  bool isButtonSelected = false;
  final vendorStaffController = Get.put(VendorController());
                          ...
                          return Wrap(
                            children: [
                              Column(
                                ...
                                children: [
                                  Visibility(
                                    visible: vendorStaffController
                                        .isShowVisible.isTrue,
                                    child: Column(
                                      crossAxisAlignment:
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        vendorStaffController.ContainerHide();
                                      },
                                      child: Container(
                                        decoration: BoxDecoration(
                                            borderRadius:
