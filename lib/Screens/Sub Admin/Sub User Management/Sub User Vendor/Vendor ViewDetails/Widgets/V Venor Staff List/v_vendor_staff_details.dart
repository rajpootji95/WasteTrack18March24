...
class VVendorStaffDetails extends StatefulWidget {
  const VVendorStaffDetails({super.key});

  @override
  State<VVendorStaffDetails> createState() => _VVendorStaffDetailsState();
}

class _VVendorStaffDetailsState extends State<VVendorStaffDetails> {
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.pushNamed(context,
                                AppScreen.vendorPurSerialDetailsScreen);
                          },
                          child: Padding(
