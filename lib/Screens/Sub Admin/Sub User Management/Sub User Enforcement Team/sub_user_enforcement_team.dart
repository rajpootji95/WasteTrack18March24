...
class SubUserEnforcementTeam extends StatefulWidget {
  const SubUserEnforcementTeam({super.key});

  @override
  State<SubUserEnforcementTeam> createState() => _SubUserEnforcementTeamState();
}

class _SubUserEnforcementTeamState extends State<SubUserEnforcementTeam> {
  bool isButtonSelected = false;
  final enforcementTeamController = Get.put(EnforcementController());
                  ...
                  return Obx(
                    () {
                      return Column(
                        children: [
                          Visibility(
                            visible: enforcementTeamController
