...
class SubUserNylonProCompany extends StatefulWidget {
  const SubUserNylonProCompany({super.key});

  @override
  State<SubUserNylonProCompany> createState() => _SubUserNylonProCompanyState();
}

class _SubUserNylonProCompanyState extends State<SubUserNylonProCompany> {
  bool isButtonSelected = false;
  final nylonProductionAgeController = Get.put(NylonProCompanyController());
                  ...
                  return Obx(
                    () {
                      return Column(
                        children: [
                          Visibility(
                            visible: nylonProductionAgeController
