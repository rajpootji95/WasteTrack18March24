...
class SubAdminTicketing extends StatefulWidget {
  const SubAdminTicketing({super.key});

  @override
  State<SubAdminTicketing> createState() => _SubAdminTicketingState();
}

class _SubAdminTicketingState extends State<SubAdminTicketing>
                                ...
                                children: List.generate(
                                  ...
                                  (index) => GestureDetector(
                                    onTap: () {
                                      Navigator.pushNamed(
                                        context,
                                        AppScreen.subTicketingDetailsScreen,
                                      );
                                    },
                                    child: Slidable(
                                      key: ValueKey(index),
