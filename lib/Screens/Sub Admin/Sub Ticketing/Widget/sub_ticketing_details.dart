...
class SubTicketingDetails extends StatefulWidget {
  const SubTicketingDetails({super.key});

  @override
  State<SubTicketingDetails> createState() => _SubTicketingDetailsState();
}

class _SubTicketingDetailsState extends State<SubTicketingDetails> {
