...
class SubInvoiceDetails extends StatefulWidget {
  const SubInvoiceDetails({super.key});

  @override
  State<SubInvoiceDetails> createState() => _SubInvoiceDetailsState();
}

class _SubInvoiceDetailsState extends State<SubInvoiceDetails> {
  @override
