  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppScreen.invoiceDetailsScreen:
        return MaterialPageRoute(builder: (_) => const InvoiceDetails());
      ...
      case AppScreen.WasteManagementStaffEditScreen:
        return MaterialPageRoute(
            builder: (_) => const WasteManagementStaffEdit());
      ...
      case AppScreen.allVendorDetailsScreen:
        return MaterialPageRoute(builder: (_) => const AllVendorDetails());
      ...
      case AppScreen.orderHistoryDetailsScreen:
        return MaterialPageRoute(builder: (_) => const OrderHistoryDetails());
      case AppScreen.orderHistoryInvoiceGenScreen:
        return MaterialPageRoute(
            builder: (_) => const OrderHistoryInvoiceGenerated());
      ...
      case AppScreen.nylonPlaceOrderScreen:
        return MaterialPageRoute(builder: (_) => const NylonPlaceOrder());
